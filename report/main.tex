...
\begin{longtable}{clp{5.5cm}p{3.5cm}}
\toprule
...
\multicolumn{4}{l}{\textbf{一、碳排放与交易政策参数}} \\
\midrule
...
\midrule
\multicolumn{4}{l}{\textbf{二、投资与改造成本参数}} \\
\midrule
...
\midrule
\multicolumn{4}{l}{\textbf{三、运营效率参数}} \\
\midrule
...
\midrule
\multicolumn{4}{l}{\textbf{四、容量与预算参数}} \\
\midrule
